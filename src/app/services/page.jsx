  ...
  const services = [
    {
      ...
      icon: FaHeart,
      color: "#F5A623",
      image: "/pet sitter.jpg?height=300&width=400",
    },
    {
      title: "Veterinary Care",
      icon: FaStethoscope,
      color: "#4A90E2",
      image: "/vetcare.jpg?height=300&width=400",
    },
    {
      title: "Pet Training",
      icon: FaPaw,
      color: "#7ED321",
      image: "/pet training.jpg?height=300&width=400",
    },
    {
      title: "Pet Grooming",
      icon: FaCut,
      color: "#9B59B6", // Added a new color for variety
      image: "/pet grooming.jpg?height=300&width=400",
    },
  ];
